...
export const mockProducts: Product[] = [
  ...
  { id: 'p004', slug: 'filament-pla-xanh', name: 'Filament PLA TuNi Blue', category: 'filament', categoryLabel: 'Vật liệu', price: 320000, oldPrice: 380000, rating: 4.7, reviewCount: 203, emoji: '🧵', badge: 'sale', description: 'Cuộn 1kg PLA chất lượng cao, màu signature TuNi.', material: 'PLA 1.75mm', dimensions: 'Cuộn 1kg', inStock: true, tags: ['hot-sales'] },
...
export const mockBlogPosts: BlogPost[] = [
  { id: 'b001', slug: 'cach-chon-may-in-3d-dau-tien', title: 'Cách chọn máy in 3D đầu tiên cho người mới', excerpt: 'Hướng dẫn chi tiết giúp bạn chọn máy in 3D phù hợp với nhu cầu và ngân sách.', date: '2026-04-10', author: 'TuNi Team', category: 'Hướng dẫn', emoji: '🖨️' },
  { id: 'b002', slug: 'so-sanh-pla-petg-abs', title: 'So sánh PLA, PETG và ABS: Chọn vật liệu nào?', excerpt: 'Ưu nhược điểm từng loại filament phổ biến, khi nào nên dùng loại nào.', date: '2026-04-02', author: 'TuNi Team', category: 'Kiến thức', emoji: '🧵' },
  { id: 'b003', slug: 'toi-uu-slicer-cura', title: '10 thiết lập Cura giúp bản in đẹp hơn', excerpt: 'Tip & tricks tối ưu slicer để có chất lượng in tốt nhất.', date: '2026-03-20', author: 'TuNi Team', category: 'Mẹo hay', emoji: '⚙️' },
  { id: 'b004', slug: 'in-3d-anime-figure', title: 'In 3D figure anime: từ file STL đến thành phẩm', excerpt: 'Quy trình đầy đủ để tạo ra một figure anime chất lượng phòng trưng bày.', date: '2026-03-08', author: 'TuNi Team', category: 'Hướng dẫn', emoji: '🎎' },
  { id: 'b005', slug: 'in-3d-kien-truc', title: 'Ứng dụng in 3D trong mô hình kiến trúc', excerpt: 'Làm sao in 3D giúp kiến trúc sư trình bày ý tưởng hiệu quả hơn.', date: '2026-02-25', author: 'TuNi Team', category: 'Ứng dụng', emoji: '🏛️' },
  { id: 'b006', slug: 'bao-duong-may-in-3d', title: 'Bảo dưỡng máy in 3D: checklist hàng tuần', excerpt: 'Checklist đơn giản giúp máy in của bạn luôn ở trạng thái tốt nhất.', date: '2026-02-10', author: 'TuNi Team', category: 'Bảo dưỡng', emoji: '🔧' },
];
...
export const ORDERS_KEY = 'tuni-orders';
